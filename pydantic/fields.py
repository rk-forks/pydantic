...
def Field(  # C901
    ...
    **extra: Unpack[_EmptyKwargs],
    ...
    if min_items is not None:
        warn(
            PydanticDeprecationWarning(
                '`min_items` is deprecated and will be removed, use `min_length` instead', version_info=(2, 0)
            )
        )
    ...
    if max_items is not None:
        warn(
            PydanticDeprecationWarning(
                '`max_items` is deprecated and will be removed, use `max_length` instead', version_info=(2, 0)
            )
        )
    ...
    if allow_mutation is not None:
        warn(
            PydanticDeprecationWarning(
                '`allow_mutation` is deprecated and will be removed. use `frozen` instead', version_info=(2, 0)
            )
        )
